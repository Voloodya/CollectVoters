...
namespace CollectVoters.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(Db_usersContext context)
        {
            _context = context;
        }
        ...
        {
            var db_usersContext = _context.User.Include(u => u.Role).Include(u=>u.Friends);

            await db_usersContext.ForEachAsync(u=>u.numberFriends=Convert.ToString(u.Friends.Count));
